...
const ThankYou = () => {
  return (
    <div className='max-w-lg m-auto text-center flex flex-col items-center gap-4 mt-4' >
      ...
      <h1 className=' text-slate-900 text-2xl'> Thank you </h1>
      <h4>Your order has been received. Our agent will get to you to confirm your order and for payment details.</h4>
      <Link href={`/`} passHref>
